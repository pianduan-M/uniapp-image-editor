...
const invokeCreateErrorHandler = once$1((app, createErrorHandler2) => {
...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__F40F782",
    appName: "pd-image-editor",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
function renderComponentRoot(instance) {
  const { type: Component2, vnode, proxy, withProxy, props, propsOptions: [propsOptions], slots, attrs, emit: emit3, render, renderCache, data, setupState, ctx, uid: uid2, appContext: { app: { config: { globalProperties: { pruneComponentPropsCache: pruneComponentPropsCache2 } } } }, inheritAttrs } = instance;
  ...
  try {
    if (vnode.shapeFlag & 4) {
      ...
      result = render2.length > 1 ? render2(props, { attrs, slots, emit: emit3 }) : render2(
        props,
        null
...
function createEmitFn(oldEmit, ctx) {
  return function emit3(event, ...args) {
...
const findMixinRuntimeHooks = /* @__PURE__ */ once$1(() => {
  const runtimeHooks = [];
  const app = isFunction(getApp) && getApp({ allowDefault: true });
...
var events = {
  get exports() {
    return exports.eventsExports;
  },
  set exports(v) {
    exports.eventsExports = v;
  }
};
...
exports.eventsExports.once = once2;
