...
const pages_index_ImageEditor_objects_Rectangle = require("../objects/Rectangle.js");
class InitPaintRect {
  constructor(editor) {
    this.editor = editor;
    this.isMove = false;
  ...
  handleTouchstart(evt) {
    if (this.editor.mode !== pages_index_ImageEditor_enum_imageEditorModeEnum.ToolModeEnum.RECT) {
      return;
    }
    ...
    if (obj) {
      ...
      if (evt.touches.length === 1) {
        obj = new pages_index_ImageEditor_objects_Rectangle.Rectangle({ color: "transparent", x, y });
        this.editor.add(obj);
      } else {
        return;
      }
...
exports.InitPaintRect = InitPaintRect;
